         ...
         <div className="tab-container" style={{marginTop: "100px", marginLeft: "220px"}}>
          ...
          <div className='row'>
                <table style={{width: "100%", maxWidth: "60vh", textAlign: "left", position: "absolute", left: "300px", marginTop: "30px"}}>
                        <tr style={{height: "40px"}}>
                        <td style={{borderRight: "3px solid lightgray"}}>
                              <NavLink id="tab" to="/access" style={{paddingLeft: "30px", paddingRight: "70px"}}>Role</NavLink>
                          </td>
                          <td>
                              <NavLink id="tab" to="/access/access2" style={{ paddingLeft: "60px", textDecoration: "none", color: "#004ea2"}}><span className='second-word'>A</span>ccess Level</NavLink>
                          </td>
                        </tr>
