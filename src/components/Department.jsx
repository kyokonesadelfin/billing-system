             ...
             <div className="tab-container" style={{marginTop: "95px"}}>
              <table style={{width: "100%", maxWidth: "200vh", height: "100%", textAlign: "center"}}>
                  ...
                  <td style={{borderRight: "3px solid lightgray"}}>
                    ...
                    <td style={{borderRight: "3px solid lightgray"}}>
                        <NavLink id="tab" to="/department" style={{textDecoration: "none", color: "#004ea2", fontWeight: "600"}}><span className='second-word'>D</span>epartment</NavLink>
                    </td> 
                ...
                <form className="d-flex pt-4" role="search" style={{display: "inline", width: "900px"}}>
                    <div className='col-md-10'>
                      ...
                      <div className='col-md-2' style={{position: "absolute", right: "0", width: "100%", maxWidth: "700px"}}>
                        <button style={{position: "absolute", right: "100px", width: "200px", fontSize: "14px"}}>Create New Department</button>
                      </div>   
                </form>
              </div>
