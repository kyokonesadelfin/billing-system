  ...
  return (
    <div>
      ...
      <div className="navbar" style={{height: "100%", width: "100%", maxHeight: "11vh", padding: "0", position: "fixed", background: "white", marginLeft: "30px"}}>
        ...
        <div className="col-md-8 mt-3" style={{background: "white"}}>
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-8 col-sm-6 mt-4">
                      ...
                      <div class="col-md-4 col-sm-6 mt-4">
                        <button className="me-2" style={{border: "0px solid #fff", width: "100%", maxWidth: "150px"}}>Discard changes</button>
                        <button style={{border: "0px solid #fff"}}>Next</button>
                      </div>
                  </div>
