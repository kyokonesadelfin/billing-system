  ...
  return (
    <div>
        <div className="container-fluid">
            <header>
               <nav class="navbar fixed-top" style={{height: "100%", maxHeight: "13vh", backgroundColor: "none"}}>
                 <div className="container-fluid">
            ...
            <main style={{overflowY: "scroll", paddingBottom: "20vh", width: "100%", maxWidth: "180vh", position: "fixed", left: "250px", top: "90px",backgroundColor: "#F2F2F2" }}>
                <div className='container-fluid'>
                    ...
                    <div style={{border: "solid 0px #000000", margin: "10px", paddingTop: "20px", backgroundColor: "white", height: "120vh", paddingLeft: "10px", paddingRight: "10px", boxShadow: "5px 5px 10px #999"}}>
                         ...
                         <div style={{border: "solid 0px #000000", marginTop: "5px",marginLeft: "30px", marginRight: "30px", padding: "0", backgroundColor: "#F2F2F2", height: "100vh", boxShadow: "5px 5px 10px #999"}}>
                              <div style={{padding: "20px"}}>
                                <table className="table" style={{borderBottom: "1px solid black"}}>
                                  <thead>
                                  <span className='fw-bolder' style={{fontSize: "large"}}>All open tickets</span>
                                    <tr>
